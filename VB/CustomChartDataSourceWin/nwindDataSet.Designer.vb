...
Namespace CustomChartDataSourceWin
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal CategoryName As String, ByVal OrderDate As System.DateTime, ByVal Quantity As Short, ByVal Extended_Price As Decimal, ByVal Sales_Person As String) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { CategoryName, OrderDate, Quantity, Extended_Price, Sales_Person}
	...
	End Class
End Namespace
Namespace CustomChartDataSourceWin.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CategoryName, OrderDate, Quantity, [Extended Price], [Sales Person] FROM S" & "alesPerson"
